...
<form action="updateDoc.action" method="post" onsubmit="return sub()">
        ...
        <tr valign="top">
            <td>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
                    ...
                    <tr>
                        <td class="font3 fftd">
                            文档标题：<input type="text" name="doname" size="30" id="title" value=${doc.doname}></td>
                    </tr>
                    ...
                    <tr>
                        <td class="font3 fftd">文档描述：<br/>
                            <textarea name="dodesc" cols="88" rows="11" id="content">${doc.dodesc}</textarea>
                        </td>
                    </tr>
                    <tr>
                        <td class="main_tdbor"></td>
