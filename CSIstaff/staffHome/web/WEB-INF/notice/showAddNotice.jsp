...
<!-- 请求异常错误  -->
<form action="addNoti.action" method="post" onsubmit="return sub()">
<table width="100%" height="90%" border="0" cellpadding="10" cellspacing="0" class="main_tabbor">
    <tr valign="top">
        <td>
            ...
            <input type="hidden" name="cuname" value=${user.uname}>
            <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
                <tr><td class="font3 fftd">
                    公告标题：<input type="text" name="notname" size="30" id="title"/>
