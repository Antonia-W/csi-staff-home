        ...
        <div class="input_text" >
            ...
            <div class="content" >
                ...
                <div class="formitem">
                    ...
                    <span class="input">
					        		<input id="uname" name="uname" value="" class="form-control l35" fv_type="NOTCN" type="text" maxlength="20" placeholder="请输入您的用户名" value=""  data-toggle="tooltip" data-placement="right">
					        	</span>
                </div>
                <div class="formitem">
                    <span class="icon fa fa-key"></span>
                    <span class="input">
					        		<input id="pwd" name="pwd" value="" class="form-control highlight_green l35" fv_type="NOTCN" type="password"  maxlength="20" placeholder="请输入您的密码"  data-toggle="tooltip" data-placement="right">
					        	</span>
                </div>
                ...
                <div >
                    <button type="submit" id="login-submit-btn" class="layui-btn  btn-login"  style="width:150px">&nbsp;&nbsp;登　录&nbsp;&nbsp;</button>
                    <button type="button" title="刷脸登录" data-search-open="" data-title="刷脸登录" modal-toggle="modal" data-href="go.action?go=face/face.jsp" data-width="780" data-height="500" class="layui-btn  btn-login"  style="width:150px">&nbsp;&nbsp;刷    脸&nbsp;&nbsp;</button>
                </div>
