...
function loadMenu(){
	...
	+'"childs": [{"id": "11","name": "用户管理","icon": "/xingxing.png","url": "getAllUser.action?page=1","parentId": "1",'
	+'"childs": [{"id": "111","name": "用户查询","icon": "","url": "getAllUser.action","parentId": "11",'
	+'"childs": []},{"id": "112","name": "添加用户","icon": "","url": "go.action?go=user/showAddUser.jsp","parentId": "11",'
	+'"childs": []}]},{"id": "12","name": "部门管理","icon": "/xingxing.png","url": "getAllDep.action","parentId": "1",'
	+'"childs": [{"id": "121","name": "部门查询","icon": "","url": "getAllDep.action","parentId": "12",'
	+'"childs": []},{"id": "122","name": "添加部门","icon": "","url": "go.action?go=dept/showAddDept.jsp","parentId": "12",'
	+'"childs": []}]},{"id": "14","name": "职位管理","icon": "/xingxing.png","url": "getAllPost.action","parentId": "1",'
	+'"childs": [{"id": "141","name": "职位查询","icon": "","url": "getAllPost.action","parentId": "14",'
	+'"childs": []},{"id": "142","name": "添加职位","icon": "","url": "go.action?go=job/showAddJob.jsp","parentId": "14",'
	+'"childs": []}]},{"id": "15","name": "员工管理","icon": "/xingxing.png","url": "getAllStaff.action","parentId": "1",'
	+'"childs": [{"id": "151","name": "员工查询","icon": "","url": "getAllStaff.action","parentId": "15",'
	+'"childs": []},{"id": "152","name": "添加员工","icon": "","url": "getDP.action","parentId": "15",'
	+'"childs": []}]},{"id": "16","name": "公告管理","icon": "/xingxing.png","url": "getAllNoti.action","parentId": "1",'
	+'"childs": [{"id": "161","name": "公告查询","icon": "","url": "getAllNoti.action","parentId": "16",'
	+'"childs": []},{"id": "162","name": "添加公告","icon": "","url": "toaddNotice.action","parentId": "16",'
	+'"childs": []}]},{"id": "17","name": "下载中心","icon": "/xingxing.png","url": "getAllDoc.action","parentId": "1",'
	+'"childs": [{"id": "171","name": "文档查询","icon": "","url": "getAllDoc.action","parentId": "17",'
	+'"childs": []},{"id": "172","name": "上传文档","icon": "","url": "toupload.action","parentId": "17","childs": []}]}]}]';
	// jquery的方法
...
function loginOut(){
	window.location.replace("go.action?go=login.jsp");
	/*
	$.ajax({
        type: "POST",
