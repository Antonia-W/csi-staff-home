    ...
    <script type="text/javascript">
        ...
        function sub(){
            ...
            if ($.trim(uname.val()) == ""){
                msg = "登录名不能为空！";
                name.focus();
            }else if($.trim(uname.val()).length<6 || $.trim(uname.val()).length>20){
                msg = "登录名需要大于6位小于20位！";
                uname.focus();
...
<form action="addStaff.action" method="post" onsubmit="return sub()">
    ...
    <tbody><tr valign="top">
        <td>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
                <tbody><tr><td class="font3 fftd">
                    <table>
                        <tbody><tr>
                            ...
                            <td class="font3 fftd">身份证号码：<input type="text" name="idnum" id="cardId" size="20"></td>
                        </tr>
                        <tr>
                            ...
                            <td class="font3 fftd">职&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;位：
                                <select name="poid" style="width:143px;">
                        ...
                        <tr>
                            <td class="font3 fftd">学历：<input name="edubg" id="education" size="20"></td>
                            <td class="font3 fftd">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱：<input name="email" id="email" size="20"></td>
                        </tr>
                        <tr>
                            <td class="font3 fftd">手机：<input name="mobie" id="phone" size="20"></td>
                ...
                <tr>
                    <td class="font3 fftd">
                        政治面貌：<input name="polista" id="party" size="40">&nbsp;&nbsp;
                ...
                <tr>
                    <td class="font3 fftd">
                        ...
                        爱&nbsp;&nbsp;&nbsp;&nbsp;好：<input name="hobie" id="hobby" size="20">
                    </td>
                </tr>
                <tr><td class="main_tdbor"></td></tr>
                ...
                <tr>
                    <td class="font3 fftd">
                        备&nbsp;&nbsp;&nbsp;&nbsp;注：<input name="ps" id="remark" size="40">
                        &nbsp;&nbsp;所属部门：
                        <select name="deid" style="width:143px;">
