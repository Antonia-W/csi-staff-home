...
<form action="addUser.action" method="post" onsubmit="return sub()">
        ...
        <td>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
                <tr><td class="font3 fftd">
                    <table>
                        <tr>
                            <td class="font3 fftd">姓&nbsp;名：<input type="text" name="name" id="username" size="20"/></td>
                        ...
                        <tr>
                            <td class="font3 fftd">登录名：<input name="uname" id="loginname" size="20" /></td>
                            <td class="font3 fftd">密&nbsp;码：<input name="pwd" id="password" size="20" /></td>
